...
class checkConfig
{
	...
	private $writeable_dir   = array('.','config','config/db.php','config/site.php','install');
	private $readable_dir    = array('install/db.php','install/site.php','install/hdshop.sql','install/region.sql');
	private
