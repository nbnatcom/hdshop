...
class IndexController extends HomeBaseController {
	...
	public function detail() {
        ...
        $goods_attrs = model('goods_attribute')->join(C('TAGLIB_NAME').'_attribute ON '.C('TAGLIB_NAME').'_goods_attribute.attribute_id='.C('TAGLIB_NAME').'_attribute.id')->where(C('TAGLIB_NAME').'_goods_attribute.type=1 and goods_id='.$id)->field('attribute_id,attribute_value,name')->select();
		$attr=array();
