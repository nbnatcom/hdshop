	...
	*/
    ...
    public function setparcel(){
    	...
    	$ordermap=array();
	    	...
	    	$goodsinfo=array();
	    	$ordergoodsinfo=$this->goods_db->join(C('TAGLIB_NAME')."_goods ON ".C('TAGLIB_NAME')."_order_goods.goods_id=".C('TAGLIB_NAME')."_goods.id")->join(C('TAGLIB_NAME')."_goods_products ON ".C('TAGLIB_NAME')."_goods.id=".C('TAGLIB_NAME')."_goods_products.goods_id and ".C('TAGLIB_NAME')."_order_goods.spec_array=".C('TAGLIB_NAME')."_goods_products.spec_array")->where($ordermap)->select();
	    	$total_number=array();
