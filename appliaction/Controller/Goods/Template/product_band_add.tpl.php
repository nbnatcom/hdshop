<?php include $this->admin_tpl("header"); ?>
    ...
    <div class="content">
        ...
        <div class="site">
            Haidao Board <a href="#">商品管理</a> > 品牌列表 > 添加品牌
        </div>
                            ...
                            <form action="<?php echo U('Product_band/add');?>" class="addform" method="post">
                                <dd>
                                    <ul class="web">
                                        ...
                                        <li>
                                            <strong>网址：</strong>
                                            <input type="text" class="text_input" name="url" placeholder='' datatype="url" ignore="ignore"  /><span class="Validform_checktip">设置品牌链接，请填写http://</span>
                                        </li>
