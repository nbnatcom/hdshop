...
<div class="content">
    <div class="site">
        Haidao Board <a href="#">会员管理</a> > 群发优惠券
    </div>
    ...
    <div class="goods mt10">
        ...
        <div class="vip_ss">
            ...
            <ul>
                <li class='vip_group'>
                    ...
                    <?php endforeach ?>
                    <span style="margin-right:161px;">[选择发放优惠券的会员等级]</span>
                </li>
                <li class='vip_order'>
                    <strong>消费记录：</strong>
                ...
                <li>
                   ...
                   <select name="brand_id" class="brand_id" style="margin-right: 48px;">
                            ...
                            <?php endforeach ?>
                   </select><span style="margin-right:161px;">[选择购买过某个分类商品的会员]</span>
                </li>
            </ul>
        </div>
        ...
        <div class="vip_fa mt10 clearfix">
            <strong>优惠发放：</strong>
            <ul>
                <li><span>赠送优惠券</span><select name="coupons_id">
                ...
                <li><span>赠送数量</span><input type="text" name="push_num" value=" 1" datatype="n" class="input" /></li>
            </ul>
