				...
				<div class="install mt10">
					...
					<div class="install mt10">
						<dl>
							<dd>
								<ul class="web">
									<li>咨询商品：<a href="<?php echo U('Goods/index/detail', array('id' => $rs['goods_id'])) ?>" target="_blank" class="reply-pro"><?php echo $good_name; ?></a></li>
									<li>咨询会员：<?php echo $user_name; ?><span>[ <?php echo mdate($rs['time']) ?> ]</span></li>
									<li>
										<div class="fl reply_T">咨询内容：</div>
										<div class="fl reply-word"><?php echo $rs['question'] ?></div>
									</li>
									...
									<?php endif ?>
									<li>审核状态：
										<label><input type="radio" name="status" value="1" <?php echo ($rs['status'] == 1) ? 'checked' : '' ; ?>> 已审核</label>&nbsp;
										<label><input type="radio" name="status" value="0" <?php echo ($rs['status'] == 0) ? 'checked' : '' ; ?>> 未审核</label>
									</li>
								</ul>
