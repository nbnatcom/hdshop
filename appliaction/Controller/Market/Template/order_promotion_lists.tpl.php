...
<div class="content">
	<div class="site">
	Haidao Board <a href="#">运营推广</a> > 订单促销
	</div>
	<span class="line_white"></span>
	<div class="goods mt10">
		<div class="login mt10" style="border: none;">
			<table id="order_promotion_list" style="width:100%"></table>
			<div class="clear"></div>
		</div>
...
<script type="text/javascript">
	...
	$(function(){
		dom.datagrid({
			...
			columns:[[
				{field:'name',title:'订单名称',width:'15%',align:'center',fixed:true,sortable:true},
				{field:'award_type',title:'促销类型',width:'15%',align:'center',fixed:true,sortable:true,
					formatter:function(value,row,index){
						var type_text = parse_type[value];
						return type_text;
					}
				},
				...
				{field:'description',title:'促销说明',width:'15%',align:'center',fixed:true},
