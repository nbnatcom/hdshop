...
<div class="content">
	<div class="site">
		Haidao Board <a href="#">内容管理</a> &gt; 友情链接
	</div>
	<div class="line_white"></div>
	<div class="goods mt10">
		<div class="login mt10" style="border: none;">
			<table id="article_link_lists" style="width:100%"></table>
		</div>
		<div class="clear"></div>
...
<script type="text/javascript">
	...
	KindEditor.ready(function(K){
		...
		editor = K.editor({
			...
			fileManagerJson : '<?php echo U("Admin/Editor/file_manage?parentdir=link/",'','');?>',
...
//					 //添加导航
			...
			columns:[[
				{field:'logo',title:'LOGO地址',width:'30%',halign:'center',align:'center',editor:{type:'textbox',options:{buttonText:'选择'}},
				...
				{field:'name',title:'链接名称',width:'15%',halign:'center',align:'center',editor:{type:'validatebox', options:{required:true}}},
				{field:'url',title:'链接地址',width:'20%',halign:'center',align:'center',editor:{type:'validatebox', options:{required:true}}},
				{field:'sort',title:'链接排序',width:'10%',halign:'center',align:'center',editor:{type:'numberspinner', options:{required:true}}},
				{field:'descript',title:'文字说明',width:'15%',halign:'center',align:'center',editor:{type:'text'}},
